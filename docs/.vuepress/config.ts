...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    repo: 'RicoyWang/knowledge-blog', // 导航栏右侧生成Github链接
    ...
    author: {
      name: 'RicoyWang', // 必需
      link: 'https://github.com/RicoyWang' // 可选的
    },
    ...
    footer: {
      ...
      copyrightInfo:
        'RicoyWang | <a href="https://github.com/RicoyWang" target="_blank">MIT License</a>' // 博客版权信息、备案信息等，支持a标签或换行标签</br>
    },
  ...
  head: [
    ...
    ['link', { rel: 'stylesheet', href: '/css/index.css' }], //favicons，资源放在public文件夹
    [
      'meta',
      {
        name: 'keywords',
